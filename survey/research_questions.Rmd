...
### Checking correlation between visiblity/anonimity and human appearance and traveling in space
```{r}

base_df <-Telerobot_ages %>% select(matches("Q_TELEROBOT_DISP_G"), 'ResponseId','v','Q_TELEROBOT_APP_G') %>%    
  drop_na() %>%
